...
const FormsList = React.memo(({}) => {
    ...
    return (
        <div className="lista-forms-perfil">
            <InputIcon icon={<span className='material-symbols-outlined'>corporate_fare</span>} text="Nome da empresa"/>
            <InputIcon icon={<span className='material-symbols-outlined'>person</span>} text="Nome"/>
